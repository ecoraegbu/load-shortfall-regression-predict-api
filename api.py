...
static_model = load_model(
    path_to_model='/Users/umarkabir/Documents/Predict/load-shortfall-regression-predict-api/assets/trained-models/load_shortfall_simple_dt_regression.pkl')
...
@app.route('/http://34.242.120.98:5000/api_v0.1', methods=['POST'])
